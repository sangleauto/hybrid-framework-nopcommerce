...
public class UserChangePasswordPageUI {
	...
	public static final String PASSWORD_CHANGED_MESSAGE = "xpath=//div[@id='bar-notification']//p[text()='Password was changed']";
	public static final String CLOSE_ICON = "xpath=//span[@class='close']";
	public static final String PASSWORD_CHANGED_MESSAGE_BAR = "xpath=//div[@id='bar-notification']";
